    ...
    <div class="certificate">
        ...
        <div class="certificate-right-column">
            ...
            <div class="certificate-content">
                ...
                <p class="certificate-name"><?php echo $all_post_meta['certificate_name'][0]; ?></p>
                <p class="certificate-description"><?php echo $all_post_meta['certificate_description'][0]; ?></p>
            </div>

            <div class="certificate-info certificate-info--first">
                <p class="certificate-label"><?php echo $all_post_meta['certificate_course_label'][0]; ?></p>
                <p class="certificate-course"><?php echo $all_post_meta['certificate_course'][0]; ?></p>
            </div>

            <div class="certificate-info">
                <p class="certificate-label"><?php echo $all_post_meta['certificate_date_label'][0]; ?></p>
                <p class="certificate-date"><?php echo $all_post_meta['certificate_date'][0]; ?></p>
            </div>
